...
public class DealstepMapDefn {
	...
	public void User_Enters_username_and_password(DataTable creditianls){
		//Map<String, String> data= (Map<String, String>)creditianls.asMap(String.class, String.class);
		//Map<String, String> data= (Map<String, String>) creditianls.asMaps<String.class, String.class);
		...
		ele.sendKeys(data.get("password");
		}
	}
